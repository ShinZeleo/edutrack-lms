            ...
            <div class="bg-white rounded-2xl shadow-2xl border border-neutral-200 p-8 sm:p-10">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="email" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" class="pl-10 block w-full h-11 rounded-lg border-neutral-300 focus:border-emerald-500 focus:ring-emerald-500 text-base" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="password" type="password" name="password" required autocomplete="current-password" class="pl-10 block w-full h-11 rounded-lg border-neutral-300 focus:border-emerald-500 focus:ring-emerald-500 text-base" />
                        </div>
                ...
                <div class="mt-8 pt-6 border-t border-neutral-200">
                    <p class="text-center text-sm text-neutral-600">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-semibold text-emerald-600 hover:text-emerald-700 transition">Daftar sekarang</a>
                    </p>
                </div>
            </div>
        </div>
